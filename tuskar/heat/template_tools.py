...
#
#    Unless required by applicable law or agreed to in writing, sofwtare
...
from tripleo_heat_merge.merge import merge
...
def generate_scaling_params(overcloud_roles):
    """
    Given a dictionary containing a key value mapping of Overcloud Role name to
    a count of the nodes return the scaling parameters to be used by
    tripleo_heat_merge
