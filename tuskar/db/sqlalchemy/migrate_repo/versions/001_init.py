...
def upgrade(migrate_engine):
    ...
    resource_categories = Table('resource_categories', meta,
        ...
        Column('name', String(length=models.LENGTH_NAME)),
    ...
    tables = [resource_categories, resource_classes, capacities, racks,
              nodes, flavors, rack_capacities, flavor_capacities]
