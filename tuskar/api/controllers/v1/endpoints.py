...
import heatclient.exc as heatclient_exceptions
...
class EndpointsController(pecan.rest.RestController):
    ...
    def get_all(self):
        ...
        # TODO: remove this check when heatclient returns HTTP status 404
        #       instead of 500 in case of a non-existing stack
