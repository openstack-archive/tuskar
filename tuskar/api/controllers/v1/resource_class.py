...
class ResourceClassesController(rest.RestController):
    ...
    def post(self, resource_class):
        ...
        try:
            ...
            aggregate_id, flavor_id = nova.NovaClient(). \
                register_resource_class_aggregate_flavor(result)
    ...
    def delete(self, resource_class_id):
        ...
        resource_class = pecan.request.dbapi.get_resource_class(
            resource_class_id)
        pecan.request.dbapi.delete_resource_class(resource_class_id)
        #now delete the aggregate/flavors:
        nova.NovaClient().unregister_resource_class_aggregate_flavors(
            resource_class)
