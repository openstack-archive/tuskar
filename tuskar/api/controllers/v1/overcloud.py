...
def parse_counts(counts):
    ...
    :param params: List of tuskar.api.controllers.v1.models.OvercloudRoleCount
    :type  params: list
...
def filter_template_attributes(allowed_data, attributes):
    ...
    :param params: Dict of allowed attributes for template returned by
                   validating of template.
    :type  params: dict

    :param params: Dict of attributes sent from user in deploying stack
                   operation
    :type  params: Dict
