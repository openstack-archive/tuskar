...
def parse_args(args=None):
    ...
    parser.add_argument(
        'directory',
        help="The directory to import roles from."
    )

    parser.add_argument(
        '--dry-run',
        help=("Find the roles and print them out without commiting them "
              "to the store."),
        action='store_true'
    )
...
def main(args=None):
    ...
    all_roles, created, updated = load_roles(args.directory,
                                             args.dry_run)
