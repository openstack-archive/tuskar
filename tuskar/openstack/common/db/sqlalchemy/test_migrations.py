...
from tuskar.openstack.common.db.sqlalchemy import utils
from tuskar.openstack.common.gettextutils import _LE
...
def _set_db_lock(lock_path=None, lock_prefix=None):
    def decorator(f):
        ...
        def wrapper(*args, **kwargs):
            try:
                path = lock_path or os.environ.get("TUSKAR_LOCK_PATH")
