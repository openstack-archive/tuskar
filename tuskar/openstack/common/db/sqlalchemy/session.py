...
from tuskar.openstack.common.gettextutils import _LE, _LW
...
class EngineFacade(object):
    """A helper class for removing of global engine instances from tuskar.db.

    As a library, tuskar.db can't decide where to store/when to create engine
    and sessionmaker instances, so this must be left for a target application.

    On the other hand, in order to simplify the adoption of tuskar.db changes,
